...
namespace Modules\Alva\Http\Controllers\Frontend;
...
class DiscordController extends Controller
{
    ...
    {
        $client = new Client();
        $client_id = env('ALVA_DISCORD_CLIENT_ID');
        $secret_id = env('ALVA_DISCORD_SECRET_ID');
        $redirect_url = "http://alva-phpvms.test/alva/discord/oauth";
